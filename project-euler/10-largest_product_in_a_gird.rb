...
def grid_product
  ...
  product = 0
  cells = Array.new(28){|i| Array.new(28){|i| 0 }}
  20.times do |row|
    20.times do |column|
      cells[row + 4][column + 4] = grid[20 * row + column].to_i
    end
  end
  ...
  (4...24).each do |row|
    (4...24).each do |column|
      product = [
        ...
        cells[row][column + 2] * cells[row][column + 3],
        cells[row][column] * cells[row + 1][column] *
        cells[row + 2][column] * cells[row + 3][column],
